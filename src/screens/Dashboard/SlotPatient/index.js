                            ...
                            <View className="flex w-full h-full">
                                    ...
                                    <View className="w-full pl-3 pb-5 bg-white">
                                        ...
                                        <View className="pl-2">
                                            <SelectDropdown
                                                ...
                                                defaultButtonText={this.state.selectModeValue != "" && <TextComponent className1={"text-left text-md text-black"}>{this.state.selectModeValue}</TextComponent>}
                                ...
                                <View>
                                    <CalendarList
                                        ...
                                        markedDates={{
                                            [this.state.selectedDate]: { selected: true, selectedColor: 'green', selectedTextColor: 'white' }
                                        }}
                                                ...
                                                <View className="flex flex-row items-center gap-3" style={styles.wrapConent}>
                                                    {
                                                        arr.map((data, index) => {
                                                            return (
                                                                <TouchableOpacity
                                                                    style={styles.box}
                                                                    className={this.state.tabId === data ? "bg-[#5aa272]" : "bg-[#F6FAF8]"}
                                                                    onPress={() => this.setState({ tabId: data })}
                                                                >
                                                                    <TextComponent
                                                                        className1={this.state.tabId === data ? "text-white" : "text-black"}
                                                                    >
                                                                        09:00 AM
                                                                    </TextComponent>
                                                                </TouchableOpacity>
                                ...
                                <View style={styles.mainView}>
                                    <View className="w-full pl-3 pb-5 bg-white">
                                        ...
                                        <View className="pl-2">
                                            <SelectDropdown
                                                // ref={this.SelectRef}
                                                defaultButtonText={this.state.selectHealthValue != "" && <TextComponent className1={"text-left text-md text-black"}>{this.state.selectHealthValue}</TextComponent>}
                                                buttonStyle={styles.dropContent}
                                                buttonTextStyle={{ textAlign: 'left', marginLeft: getWidth("5%"), fontSize: 16 }}
                                                ...
                                                onSelect={(selectedItem, index) => this.setState({ selectHealthValue: selectedItem })}
                                                renderDropdownIcon={isOpened => {
                                                    return (
                                                        <View className="mr-5">
                                                            <FontAwesome name={isOpened ? 'chevron-up' : 'chevron-down'} color={'#444'} size={18} />
